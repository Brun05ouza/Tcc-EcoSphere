    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Transformando dados em ação sustentável</p>
        </div>
        ...
        <div className="relative flex bg-gray-100 rounded-xl p-1 mb-6">
          ...
          <motion.button
            ...
            className={`relative z-10 flex-1 py-2 px-4 rounded-lg transition-all ${
        ...
        >
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-green-500 to-blue-500 text-white py-3 px-4 rounded-xl font-semibold hover:from-green-600 hover:to-blue-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
